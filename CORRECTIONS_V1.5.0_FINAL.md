...
```env
FRONTEND_URL=https://drawshare-sync.preview.emergentagent.com
BACKEND_URL=https://drawshare-sync.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://drawshare-sync.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://drawshare-sync.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://drawshare-sync.preview.emergentagent.com`
...
curl https://drawshare-sync.preview.emergentagent.com/api/version
...
# Ouvrir : https://drawshare-sync.preview.emergentagent.com/login
...
curl -X GET https://drawshare-sync.preview.emergentagent.com/api/version \
  -H "Origin: https://drawshare-sync.preview.emergentagent.com"
