...
```env
FRONTEND_URL=https://proxmox-update.preview.emergentagent.com
BACKEND_URL=https://proxmox-update.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://proxmox-update.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://proxmox-update.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://proxmox-update.preview.emergentagent.com`
...
# Ouvrir : https://proxmox-update.preview.emergentagent.com/login
...
curl -X GET https://proxmox-update.preview.emergentagent.com/api/version \
  -H "Origin: https://proxmox-update.preview.emergentagent.com"
