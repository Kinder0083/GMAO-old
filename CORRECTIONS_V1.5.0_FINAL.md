...
```env
FRONTEND_URL=https://dashboard-live.preview.emergentagent.com
BACKEND_URL=https://dashboard-live.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://dashboard-live.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://dashboard-live.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://dashboard-live.preview.emergentagent.com`
...
# Ouvrir : https://dashboard-live.preview.emergentagent.com/login
...
curl -X GET https://dashboard-live.preview.emergentagent.com/api/version \
  -H "Origin: https://dashboard-live.preview.emergentagent.com"
