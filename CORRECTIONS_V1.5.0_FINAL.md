...
```env
FRONTEND_URL=https://team-dashboards.preview.emergentagent.com
BACKEND_URL=https://team-dashboards.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://team-dashboards.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://team-dashboards.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://team-dashboards.preview.emergentagent.com`
...
curl https://team-dashboards.preview.emergentagent.com/api/version
...
# Ouvrir : https://team-dashboards.preview.emergentagent.com/login
...
curl -X GET https://team-dashboards.preview.emergentagent.com/api/version \
  -H "Origin: https://team-dashboards.preview.emergentagent.com"
