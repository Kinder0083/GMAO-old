...
```env
FRONTEND_URL=https://dash-manager-8.preview.emergentagent.com
BACKEND_URL=https://dash-manager-8.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://dash-manager-8.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://dash-manager-8.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://dash-manager-8.preview.emergentagent.com`
...
curl https://dash-manager-8.preview.emergentagent.com/api/version
...
# Ouvrir : https://dash-manager-8.preview.emergentagent.com/login
...
curl -X GET https://dash-manager-8.preview.emergentagent.com/api/version \
  -H "Origin: https://dash-manager-8.preview.emergentagent.com"
