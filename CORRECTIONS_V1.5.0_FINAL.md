...
```env
FRONTEND_URL=https://dash-modular.preview.emergentagent.com
BACKEND_URL=https://dash-modular.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://dash-modular.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://dash-modular.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://dash-modular.preview.emergentagent.com`
...
curl https://dash-modular.preview.emergentagent.com/api/version
...
# Ouvrir : https://dash-modular.preview.emergentagent.com/login
...
curl -X GET https://dash-modular.preview.emergentagent.com/api/version \
  -H "Origin: https://dash-modular.preview.emergentagent.com"
