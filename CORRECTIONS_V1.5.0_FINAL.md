...
```env
FRONTEND_URL=https://live-camera-panel.preview.emergentagent.com
BACKEND_URL=https://live-camera-panel.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://live-camera-panel.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://live-camera-panel.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://live-camera-panel.preview.emergentagent.com`
...
curl https://live-camera-panel.preview.emergentagent.com/api/version
...
# Ouvrir : https://live-camera-panel.preview.emergentagent.com/login
...
curl -X GET https://live-camera-panel.preview.emergentagent.com/api/version \
  -H "Origin: https://live-camera-panel.preview.emergentagent.com"
