...
```env
FRONTEND_URL=https://fps-manager.preview.emergentagent.com
BACKEND_URL=https://fps-manager.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://fps-manager.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://fps-manager.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://fps-manager.preview.emergentagent.com`
...
curl https://fps-manager.preview.emergentagent.com/api/version
...
# Ouvrir : https://fps-manager.preview.emergentagent.com/login
...
curl -X GET https://fps-manager.preview.emergentagent.com/api/version \
  -H "Origin: https://fps-manager.preview.emergentagent.com"
