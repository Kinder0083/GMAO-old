...
```env
FRONTEND_URL=https://menu-maestro-78.preview.emergentagent.com
BACKEND_URL=https://menu-maestro-78.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://menu-maestro-78.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://menu-maestro-78.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://menu-maestro-78.preview.emergentagent.com`
...
# Ouvrir : https://menu-maestro-78.preview.emergentagent.com/login
...
curl -X GET https://menu-maestro-78.preview.emergentagent.com/api/version \
  -H "Origin: https://menu-maestro-78.preview.emergentagent.com"
