...
```env
FRONTEND_URL=https://maintenance-ai-3.preview.emergentagent.com
BACKEND_URL=https://maintenance-ai-3.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://maintenance-ai-3.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://maintenance-ai-3.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://maintenance-ai-3.preview.emergentagent.com`
...
curl https://maintenance-ai-3.preview.emergentagent.com/api/version
...
# Ouvrir : https://maintenance-ai-3.preview.emergentagent.com/login
...
curl -X GET https://maintenance-ai-3.preview.emergentagent.com/api/version \
  -H "Origin: https://maintenance-ai-3.preview.emergentagent.com"
