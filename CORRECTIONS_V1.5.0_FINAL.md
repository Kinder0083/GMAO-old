...
```env
FRONTEND_URL=https://frigate-webrtc-fix.preview.emergentagent.com
BACKEND_URL=https://frigate-webrtc-fix.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://frigate-webrtc-fix.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://frigate-webrtc-fix.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://frigate-webrtc-fix.preview.emergentagent.com`
...
curl https://frigate-webrtc-fix.preview.emergentagent.com/api/version
...
# Ouvrir : https://frigate-webrtc-fix.preview.emergentagent.com/login
...
curl -X GET https://frigate-webrtc-fix.preview.emergentagent.com/api/version \
  -H "Origin: https://frigate-webrtc-fix.preview.emergentagent.com"
