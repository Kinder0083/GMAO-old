...
```env
FRONTEND_URL=https://live-whiteboard.preview.emergentagent.com
BACKEND_URL=https://live-whiteboard.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://live-whiteboard.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://live-whiteboard.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://live-whiteboard.preview.emergentagent.com`
...
curl https://live-whiteboard.preview.emergentagent.com/api/version
...
# Ouvrir : https://live-whiteboard.preview.emergentagent.com/login
...
curl -X GET https://live-whiteboard.preview.emergentagent.com/api/version \
  -H "Origin: https://live-whiteboard.preview.emergentagent.com"
