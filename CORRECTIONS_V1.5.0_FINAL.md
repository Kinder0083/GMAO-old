...
```env
FRONTEND_URL=https://filebug-fixer.preview.emergentagent.com
BACKEND_URL=https://filebug-fixer.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://filebug-fixer.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://filebug-fixer.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://filebug-fixer.preview.emergentagent.com`
...
curl https://filebug-fixer.preview.emergentagent.com/api/version
...
# Ouvrir : https://filebug-fixer.preview.emergentagent.com/login
...
curl -X GET https://filebug-fixer.preview.emergentagent.com/api/version \
  -H "Origin: https://filebug-fixer.preview.emergentagent.com"
