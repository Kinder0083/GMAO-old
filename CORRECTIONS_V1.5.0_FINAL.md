...
```env
FRONTEND_URL=https://iotchat.preview.emergentagent.com
BACKEND_URL=https://iotchat.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://iotchat.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://iotchat.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://iotchat.preview.emergentagent.com`
...
curl https://iotchat.preview.emergentagent.com/api/version
...
# Ouvrir : https://iotchat.preview.emergentagent.com/login
...
curl -X GET https://iotchat.preview.emergentagent.com/api/version \
  -H "Origin: https://iotchat.preview.emergentagent.com"
