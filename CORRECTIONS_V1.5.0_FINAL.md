...
```env
FRONTEND_URL=https://socketdata-hub.preview.emergentagent.com
BACKEND_URL=https://socketdata-hub.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://socketdata-hub.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://socketdata-hub.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://socketdata-hub.preview.emergentagent.com`
...
curl https://socketdata-hub.preview.emergentagent.com/api/version
...
# Ouvrir : https://socketdata-hub.preview.emergentagent.com/login
...
curl -X GET https://socketdata-hub.preview.emergentagent.com/api/version \
  -H "Origin: https://socketdata-hub.preview.emergentagent.com"
