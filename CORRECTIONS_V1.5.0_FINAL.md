...
```env
FRONTEND_URL=https://realtimesync.preview.emergentagent.com
BACKEND_URL=https://realtimesync.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://realtimesync.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://realtimesync.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://realtimesync.preview.emergentagent.com`
...
curl https://realtimesync.preview.emergentagent.com/api/version
...
# Ouvrir : https://realtimesync.preview.emergentagent.com/login
...
curl -X GET https://realtimesync.preview.emergentagent.com/api/version \
  -H "Origin: https://realtimesync.preview.emergentagent.com"
