...
```env
FRONTEND_URL=https://scripts-cleanup.preview.emergentagent.com
BACKEND_URL=https://scripts-cleanup.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://scripts-cleanup.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://scripts-cleanup.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://scripts-cleanup.preview.emergentagent.com`
...
curl https://scripts-cleanup.preview.emergentagent.com/api/version
...
# Ouvrir : https://scripts-cleanup.preview.emergentagent.com/login
...
curl -X GET https://scripts-cleanup.preview.emergentagent.com/api/version \
  -H "Origin: https://scripts-cleanup.preview.emergentagent.com"
