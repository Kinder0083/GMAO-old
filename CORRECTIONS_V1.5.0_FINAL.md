...
```env
FRONTEND_URL=https://board-fix.preview.emergentagent.com
BACKEND_URL=https://board-fix.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://board-fix.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://board-fix.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://board-fix.preview.emergentagent.com`
...
curl https://board-fix.preview.emergentagent.com/api/version
...
# Ouvrir : https://board-fix.preview.emergentagent.com/login
...
curl -X GET https://board-fix.preview.emergentagent.com/api/version \
  -H "Origin: https://board-fix.preview.emergentagent.com"
