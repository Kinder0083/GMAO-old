...
```env
FRONTEND_URL=https://maint-calendar.preview.emergentagent.com
BACKEND_URL=https://maint-calendar.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://maint-calendar.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://maint-calendar.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://maint-calendar.preview.emergentagent.com`
...
curl https://maint-calendar.preview.emergentagent.com/api/version
...
# Ouvrir : https://maint-calendar.preview.emergentagent.com/login
...
curl -X GET https://maint-calendar.preview.emergentagent.com/api/version \
  -H "Origin: https://maint-calendar.preview.emergentagent.com"
