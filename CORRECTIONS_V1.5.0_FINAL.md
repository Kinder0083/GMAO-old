...
```env
FRONTEND_URL=https://whitesync.preview.emergentagent.com
BACKEND_URL=https://whitesync.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://whitesync.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://whitesync.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://whitesync.preview.emergentagent.com`
...
curl https://whitesync.preview.emergentagent.com/api/version
...
# Ouvrir : https://whitesync.preview.emergentagent.com/login
...
curl -X GET https://whitesync.preview.emergentagent.com/api/version \
  -H "Origin: https://whitesync.preview.emergentagent.com"
