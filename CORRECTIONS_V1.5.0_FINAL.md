...
```env
FRONTEND_URL=https://checklist-control.preview.emergentagent.com
BACKEND_URL=https://checklist-control.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://checklist-control.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://checklist-control.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://checklist-control.preview.emergentagent.com`
...
curl https://checklist-control.preview.emergentagent.com/api/version
...
# Ouvrir : https://checklist-control.preview.emergentagent.com/login
...
curl -X GET https://checklist-control.preview.emergentagent.com/api/version \
  -H "Origin: https://checklist-control.preview.emergentagent.com"
