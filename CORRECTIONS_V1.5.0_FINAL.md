...
```env
FRONTEND_URL=https://proxmox-debugger.preview.emergentagent.com
BACKEND_URL=https://proxmox-debugger.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://proxmox-debugger.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://proxmox-debugger.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://proxmox-debugger.preview.emergentagent.com`
...
curl https://proxmox-debugger.preview.emergentagent.com/api/version
...
# Ouvrir : https://proxmox-debugger.preview.emergentagent.com/login
...
curl -X GET https://proxmox-debugger.preview.emergentagent.com/api/version \
  -H "Origin: https://proxmox-debugger.preview.emergentagent.com"
