...
```env
FRONTEND_URL=https://supervisor-crash.preview.emergentagent.com
BACKEND_URL=https://supervisor-crash.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://supervisor-crash.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://supervisor-crash.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://supervisor-crash.preview.emergentagent.com`
...
curl https://supervisor-crash.preview.emergentagent.com/api/version
...
# Ouvrir : https://supervisor-crash.preview.emergentagent.com/login
...
curl -X GET https://supervisor-crash.preview.emergentagent.com/api/version \
  -H "Origin: https://supervisor-crash.preview.emergentagent.com"
