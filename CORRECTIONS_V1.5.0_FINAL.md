...
```env
FRONTEND_URL=https://tooltip-master.preview.emergentagent.com
BACKEND_URL=https://tooltip-master.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://tooltip-master.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://tooltip-master.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://tooltip-master.preview.emergentagent.com`
...
curl https://tooltip-master.preview.emergentagent.com/api/version
...
# Ouvrir : https://tooltip-master.preview.emergentagent.com/login
...
curl -X GET https://tooltip-master.preview.emergentagent.com/api/version \
  -H "Origin: https://tooltip-master.preview.emergentagent.com"
