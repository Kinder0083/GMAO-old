...
```env
FRONTEND_URL=https://neartrack.preview.emergentagent.com
BACKEND_URL=https://neartrack.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://neartrack.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://neartrack.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://neartrack.preview.emergentagent.com`
...
curl https://neartrack.preview.emergentagent.com/api/version
...
# Ouvrir : https://neartrack.preview.emergentagent.com/login
...
curl -X GET https://neartrack.preview.emergentagent.com/api/version \
  -H "Origin: https://neartrack.preview.emergentagent.com"
