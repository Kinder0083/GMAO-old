...
```env
FRONTEND_URL=https://gmao-iris-webrtc.preview.emergentagent.com
BACKEND_URL=https://gmao-iris-webrtc.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://gmao-iris-webrtc.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://gmao-iris-webrtc.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://gmao-iris-webrtc.preview.emergentagent.com`
...
curl https://gmao-iris-webrtc.preview.emergentagent.com/api/version
...
# Ouvrir : https://gmao-iris-webrtc.preview.emergentagent.com/login
...
curl -X GET https://gmao-iris-webrtc.preview.emergentagent.com/api/version \
  -H "Origin: https://gmao-iris-webrtc.preview.emergentagent.com"
