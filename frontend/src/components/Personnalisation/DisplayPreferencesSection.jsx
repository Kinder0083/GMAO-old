...
const DisplayPreferencesSection = () => {
  ...
  const availablePages = [
    ...
    { value: '/service-dashboard', label: 'Dashboard Service', module: 'serviceDashboard' },
    { value: '/chat-live', label: 'Chat Live', module: 'chatLive' },
    ...
    { value: '/planning-mprev', label: 'Planning M.Prev.', module: 'planningMprev' },
    { value: '/assets', label: 'Équipements', module: 'assets' },
    { value: '/inventory', label: 'Inventaire', module: 'inventory' },
    { value: '/purchase-requests', label: 'Demandes d\'Achat', module: 'purchaseRequests' },
    ...
    { value: '/surveillance-rapport', label: 'Rapport Surveillance', module: 'surveillanceRapport' },
    { value: '/weekly-reports', label: 'Rapports Hebdomadaires', module: 'weeklyReports' },
    { value: '/presqu-accident', label: 'Presqu\'accident', module: 'presquaccident' },
    { value: '/presqu-accident-rapport', label: 'Rapport P.accident', module: 'presquaccidentRapport' },
    { value: '/team-management', label: 'Gestion d\'équipe', module: 'timeTracking' },
    { value: '/cameras', label: 'Caméras', module: 'cameras' },
    { value: '/mes', label: 'M.E.S.', module: 'mes' },
    { value: '/mes-reports', label: 'Rapports M.E.S.', module: 'mesReports' },
    { value: '/analytics/checklists', label: 'Analytics Checklists', module: 'analyticsChecklists' },
