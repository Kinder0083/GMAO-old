#!/usr/bin/env python3
"""
Script wrapper pour générer le manuel complet avec 23 chapitres
Exécute d'abord le script de base (12 chapitres) puis ajoute les 11 chapitres supplémentaires
"""
import asyncio
import sys
import os
...
# Import du script de base
from generate_complete_manual import generate_manual as generate_base_12ch
